...
Remember, the problem can also be solved without this algorithm, this is because the test cases contained only one number as input,
if I asked answer for multiple numbers in single input, then other approaches can fail. 
Test cases were made easy considering the level of all participants.
Using this algorithm you can make a boolean array whose index i tells if a number i is prime or not.
